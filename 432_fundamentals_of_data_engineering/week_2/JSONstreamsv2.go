...
func CalcDifference(funcname string, premem runtime.MemStats, postmem runtime.MemStats) {
	...
	fmt.Println("Allocated for Serialize : ", postmem.Alloc-premem.Alloc, "\n")
	fmt.Println("Total Allocated for Serialize : ", postmem.TotalAlloc-premem.TotalAlloc, "\n")
	fmt.Println("Total Memory from OS : ", postmem.Sys-premem.Sys, "\n")
	fmt.Println("Completed GC Cycles : ", postmem.NumGC-premem.NumGC, "\n")
	fmt.Println("\n\n ***********  Serialize Mem Usage END *********** \n")
}
...
func main() {
	...
	//convert the below to a function
