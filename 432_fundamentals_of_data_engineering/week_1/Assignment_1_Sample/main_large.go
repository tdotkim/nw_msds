//parse error is around the time stamp format where the sample file was m/d/yyyy HH:mm (24hr)
// the full dataset is in MM/dd/yyyy hh:mm:ss a
//the fix is "01/02/2006 03:04:05 PM" instead of "1/2/2006 15:04" on line 254
// this keeps the 1-2-3-4-5-6 format
// wile accounting for 24h to 12h + seconds and am/pm

//also no zip data in the raw data
...
func main() {
	...
	dataset, err := os.Open("Traffic_Crashes_-_Crashes.csv") // after running with large data set change it to Traffic_Crashes_-_Crashes.csv
